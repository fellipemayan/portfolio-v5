...
export default function ContactPageClient({ socialLinks }: ContactPageClientProps) {
  const formspreeId = process.env.NEXT_PUBLIC_FORMSPREE_ID;
  const [state, handleSubmit, resetFormspree] = useForm(formspreeId || '');
  const { setDynamicText } = useCursorContext();
    ...
    <>
      ...
      >
        ...
        <motion.p className="" variants={itemVariants}>
          ...
          , pelas minhas redes sociais ou através do formulário abaixo. Sinta-se à vontade para compartilhar
      ...
      >
        ...
        >
          ...
          <div className="input-wrapper">
            <input id="name" type="text" name="name" required onBlur={handleNameBlur} />
          </div>
          <ValidationError
            prefix="Nome"
            field="name"
